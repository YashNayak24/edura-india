...
const quickLinks = [
  ...
  { label: 'Placement Mastery', href: '/about' },
...
const courses = [
  { label: 'Basic Computer Course', href: '/courses/basic-computer-course-delhi' },
  { label: 'Advanced Computer', href: '/courses/adca-course-delhi' },
  { label: 'Graphic Designing', href: '/courses/graphic-design-course-delhi' },
  { label: 'Video Editing', href: '/courses/video-editing-course-delhi' },
  { label: 'Digital Marketing', href: '/courses/digital-marketing-course-delhi' },
  { label: 'Stock Market Trading', href: '/courses' },
  { label: 'Data Analyst', href: '/courses/data-analyst-course-delhi' },
  { label: 'Web Design & Dev', href: '/courses/web-designing-course-delhi' },
  { label: 'C / C++ / Java / Python', href: '/courses/java-full-stack-course-delhi' },
  { label: 'UI / UX Design', href: '/courses/graphic-design-course-delhi' },
];
        ...
        <div className="footer-inner">
          <div className="footer-grid">
            ...
            <div className="footer-col-brand">
              ...
              <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
                {socialLinks.map(s => (
                  <a key={s.title} href={s.href} title={s.title} aria-label={s.title} target="_blank" rel="noopener noreferrer" className="footer-social-link">
                    {s.icon}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              {quickLinks.map(l => (
                <Link key={l.label} href={l.href} className="footer-nav-link">
            ...
            <div>
              ...
              {courses.map(c => (
                <Link key={c.label} href={c.href} className="footer-nav-link">
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-bottom-links" style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
              {policyLinks.map(l => (
                <Link key={l.label} href={l.href} className="footer-bottom-policy">{l.label}</Link>
              ))}
            </div>
          </div>
        </div>
