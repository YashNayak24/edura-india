...
//         {/* Counselling Form */}
//         <BookDemoForm formHead="Book Free Counselling" />
...
//             </div>
//           </div>
//           <button className="flex-shrink-0 text-white px-6 py-2.5 rounded-xl font-bold text-sm sora transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
...
// /* ══ FOOTER CTA ══════════════════════════════════════════════════ */
// function FooterCTA({ course, onBookDemoClick }) {
//   const [ref, visible] = useFadeIn();
//   return (
//     /* Outer light bg — same as page */
...
//         {/* Inner content — centered, matches screenshot */}
//         <div
...
//           {/* Two buttons — same as screenshot */}
...
//       <FooterCTA course={course} onBookDemoClick={onBookDemoClick} />
//     </div>
//   );
// }
