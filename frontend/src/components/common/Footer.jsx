  ...
  return (
    <>
      ...
      <footer style={{
        ...
        <div style={{position:'absolute',top:-100,right:-100,width:420,height:420,
          borderRadius:'50%',pointerEvents:'none',zIndex:0,
          background:'radial-gradient(circle,rgba(29,90,244,0.18),transparent 65%)'}}/>
        <div style={{position:'absolute',bottom:-60,left:-80,width:300,height:300,
          borderRadius:'50%',pointerEvents:'none',zIndex:0,
        ...
        <div className="footer-inner">
          <div className="footer-grid">
            ...
            {/* COL 2: Quick Links */}
            <div>
              <h4 style={{fontSize:11,fontWeight:700,color:'rgba(255,255,255,0.85)',letterSpacing:'0.13em',
            ...
            <div>
              ...
              <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.06)',
                ...
                <div style={{display:'flex',alignItems:'center',gap:7,marginBottom:12}}>
                  <div style={{width:24,height:24,borderRadius:6,background:'rgba(245,166,35,0.12)',
